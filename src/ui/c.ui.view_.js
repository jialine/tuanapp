...
define(['libs', 'cUIAlert', 'cUIWarning', 'cUIHeadWarning', 'cUIWarning404', 'cUIToast', 'cSales', 'cStorage', 'cBase', 'CommonStore', 'cUtility', 'cAdView', 'cUILoading'], function (libs, Alert, Warning, HeadWarning, Warning404, Toast, cSales, cStorage, cBase, CommonStore, cUtility, cAdView, Loading) {
